...
class OperationalTransform:
    ...
    @staticmethod
    def transform(op1: Operation, op2: Operation, priority: str = 'left') -> Tuple[Operation, Operation]:
        """
        ...
        if op1.op_type == OperationType.INSERT and op2.op_type == OperationType.INSERT:
            op1_prime, op2_prime = OperationalTransform._transform_insert_insert(op1_prime, op2_prime, priority)
            ...
            op1_prime, op2_prime = OperationalTransform._transform_format_operations(op1_prime, op2_prime)
    ...
    @staticmethod
    def _transform_format_operations(op1: Operation, op2: Operation) -> Tuple[Operation, Operation]:
        ...
        elif op2.op_type == OperationType.FORMAT and op1.op_type != OperationType.FORMAT:
...
class OperationBuffer:
    ...
    def add_local_operation(self, operation: Operation):
        ...
        # Update vector clock
        if operation.author:
            self.vector_clock[operation.author] = self.vector_clock.get(operation.author, 0) + 1
    ...
    def _try_merge_operations(self, op1: Operation, op2: Operation) -> Optional[Operation]:
        ...
        if (op1.op_type == OperationType.INSERT and 
            op2.op_type == OperationType.INSERT and
        ...
        if (op1.op_type == OperationType.DELETE and 
            op2.op_type == OperationType.DELETE and
...
class CollaborativeEditor:
    ...
    def format_text(self, position: int, length: int, attributes: Dict[str, Any]) -> Operation:
