...
import { ClaudePlaygroundSimple } from './components/ClaudePlaygroundSimple';
import { PromptDebuggerSimple } from './components/PromptDebuggerSimple';
...
function App() {
  ...
  const [activeTab, setActiveTab] = useState<'meetings' | 'templates' | 'database' | 'audio' | 'chat' | 'debug' | 'ai' | 'playground' | 'health' | 'claude' | 'prompt-debug' | 'observatory'>('meetings');
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex space-x-1 bg-gray-100 p-1 rounded-lg">
              ...
              <button
                onClick={() => setActiveTab('prompt-debug')}
                className={`flex-1 px-4 py-2 text-sm font-medium rounded-md transition-colors ${
            ...
            {activeTab === 'claude' && (
              <div>
                <ClaudePlaygroundSimple clientId={clientId} />
                
                {/* Claude Studio Instructions */}
                <div className="mt-4 p-4 bg-indigo-50 border border-indigo-200 rounded-lg">
                  <h4 className="font-semibold text-indigo-800 mb-2">🧠 Claude Studio Features:</h4>
                  <ul className="text-sm text-indigo-700 space-y-1">
                    <li>• Direct Claude Sonnet 3.5 integration with streaming responses</li>
                    <li>• Pre-built templates for meeting analysis and summarization</li>
                    <li>• Real-time token counting and cost estimation</li>
                    <li>• Context window management and conversation history</li>
                    <li>• Advanced prompt engineering with optimization suggestions</li>
            ...
            {activeTab === 'prompt-debug' && (
              <div>
                <PromptDebuggerSimple showAdvancedAnalytics={true} />
                
                {/* Prompt Debugger Instructions */}
                <div className="mt-4 p-4 bg-orange-50 border border-orange-200 rounded-lg">
                  <h4 className="font-semibold text-orange-800 mb-2">🔍 Prompt Debugger Features:</h4>
                  <ul className="text-sm text-orange-700 space-y-1">
                    <li>• Real-time token analysis and cost breakdown</li>
                    <li>• Comprehensive prompt quality metrics and scoring</li>
                    <li>• Automated optimization suggestions and recommendations</li>
                    <li>• Cost projection tools for budget planning</li>
                    <li>• Quick optimization actions and prompt improvements</li>
                    <li>• Historical analysis tracking and comparison</li>
                  </ul>
                </div>
              </div>
            )}
            ...
            {activeTab === 'observatory' && (
              <div>
                ...
                <div className="mt-4 p-4 bg-indigo-50 border border-indigo-200 rounded-lg">
                  <h4 className="font-semibold text-indigo-800 mb-2">🏢 AI Observatory Features:</h4>
                  <ul className="text-sm text-indigo-700 space-y-1">
                    <li>• Real-time monitoring of AI orchestration system performance</li>
                    <li>• Comprehensive cost analysis and optimization insights</li>
                    <li>• A/B testing results with statistical significance analysis</li>
                    <li>• Model performance benchmarking and quality scoring</li>
                    <li>• Task complexity distribution and routing analytics</li>
                    <li>• Interactive charts and detailed metrics dashboards</li>
                  </ul>
                </div>
              </div>
            )}
