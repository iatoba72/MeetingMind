...
def register_default_settings():
    ...
    settings_registry.register(
        SettingsDefinition(
            ...
            validation_rules=[
                SettingsValidationRule(
                    "min_value", {"min": 10}, "Font size must be at least 10px"
                ),
                SettingsValidationRule(
                    "max_value", {"max": 24}, "Font size must be at most 24px"
                ),
            ],
            ui_component="slider",
    ...
    settings_registry.register(
        SettingsDefinition(
            ...
            validation_rules=[
                SettingsValidationRule(
                    "min_value", {"min": 200}, "Sidebar width must be at least 200px"
                ),
                SettingsValidationRule(
                    "max_value", {"max": 500}, "Sidebar width must be at most 500px"
                ),
            ],
            ui_component="slider",
        ...
        SettingsDefinition(
            ...
            validation_rules=[
                ...
                SettingsValidationRule(
                    "max_value",
                    {"max": 300},
                    "Auto-save interval must be at most 5 minutes",
                ),
            ],
            ui_component="select",
            ui_props={
    ...
    settings_registry.register(
        SettingsDefinition(
            ...
            validation_rules=[
                SettingsValidationRule(
                    "min_value", {"min": 1}, "Timeout must be at least 1 second"
                ),
                SettingsValidationRule(
                    "max_value", {"max": 10}, "Timeout must be at most 10 seconds"
                ),
            ],
            ui_component="slider",
    ...
    settings_registry.register(
        SettingsDefinition(
            ...
            validation_rules=[
                SettingsValidationRule(
                    "in",
                    {"values": ["immediate", "hourly", "daily", "weekly", "never"]},
                )
            ],
            ui_component="select",
            ui_props={
    ...
    settings_registry.register(
        SettingsDefinition(
            ...
            validation_rules=[
                SettingsValidationRule(
                    "in", {"values": ["low", "medium", "high", "auto"]}
                )
            ],
            ui_component="select",
            ui_props={
    ...
    settings_registry.register(
        SettingsDefinition(
            ...
            validation_rules=[
                SettingsValidationRule(
                    "min_value", {"min": 1}, "Storage limit must be at least 1GB"
                ),
                SettingsValidationRule(
                    "max_value", {"max": 1000}, "Storage limit must be at most 1000GB"
                ),
            ],
            ui_component="input",
        ...
        SettingsDefinition(
            ...
            validation_rules=[
                ...
                SettingsValidationRule(
                    "max_value",
                    {"max": 1440},
                    "Session timeout must be at most 24 hours",
                ),
            ],
            ui_component="select",
            ui_props={
    ...
    settings_registry.register(
        SettingsDefinition(
            ...
            validation_rules=[
                SettingsValidationRule(
                    "min_value", {"min": 1}, "Must allow at least 1 meeting"
                ),
                SettingsValidationRule(
                    "max_value", {"max": 1000}, "Cannot exceed 1000 meetings"
                ),
            ],
            ui_component="input",
    ...
    settings_registry.register(
        SettingsDefinition(
            ...
            validation_rules=[
                SettingsValidationRule(
                    "min_value", {"min": 1}, "Cache duration must be at least 1 minute"
                ),
                SettingsValidationRule(
                    "max_value",
                    {"max": 1440},
                    "Cache duration must be at most 24 hours",
                ),
            ],
            ui_component="slider",
        ...
        SettingsDefinition(
            ...
            validation_rules=[
                SettingsValidationRule(
                    "min_value",
                    {"min": 10},
                    "Rate limit must be at least 10 requests/minute",
                ),
                SettingsValidationRule(
                    "max_value",
                    {"max": 10000},
                    "Rate limit cannot exceed 10,000 requests/minute",
                ),
            ],
            ui_component="input",
    ...
    settings_registry.register(
        SettingsDefinition(
            ...
            validation_rules=[
                SettingsValidationRule(
                    "in", {"values": ["DEBUG", "INFO", "WARNING", "ERROR", "CRITICAL"]}
                )
            ],
            ui_component="select",
            ui_props={
